...
public class Contests {
	...
	public static String[] getContests(String sessionkey) throws IOException, NumberFormatException {
		...
		Contestdata[0] = data.substring(data.indexOf("contest_group_id")+19,data.indexOf("contest_status")-3);
		Contestdata[1] = data.substring(data.indexOf("id")+5,data.indexOf("contest_winnings")-3);   
