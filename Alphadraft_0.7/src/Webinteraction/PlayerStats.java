...
public class PlayerStats {
	...
	public static void main(String[] args) throws IOException, NumberFormatException {
		PlayerStats.getStats("http://lol.esportspedia.com/wiki/Riot_League_Championship_Series/North_America/2015_Season/Spring_Season/Match_History",null);
	}
	...
	public static Player[] getStats(String site, Player[] previousSeason) throws IOException, NumberFormatException {
		...
		String[] Teamorder = new String[600];
        String zws;
        String Playername;
        int k2;
        int i0 = 0;
       ...
       br1 = Methods.establishConnection(site);
        while ((line = br1.readLine()) != null){
        	if (line.contains("http://matchhistory.na.leagueoflegends.com/en")) {
        		...
        		String gamecode = line.substring(line.indexOf(servercode),line.indexOf(">Link</a>")-1);
             ...
             for (int i4 = 0;i4 < Methods.getObjectcountP(Playerarray);i4++) {
              ...
              //work  	// collect data from each game 2.zws
                for (int i2 = 1; i2 < 28;i2=i2+3){
                	...
                	if (zws.substring(zws.indexOf("pantId")+16,zws.indexOf("item0")-2).equals("true")){
                		...
                		Playerarray[k2].winscore[Playerarray[k2].MatchNr] = Playerarray[k2].winkills[Playerarray[k2].MatchNr]*3 - Playerarray[k2].windeaths[Playerarray[k2].MatchNr]*2
                				+ Playerarray[k2].winassists[Playerarray[k2].MatchNr] + Playerarray[k2].wincreeps[Playerarray[k2].MatchNr] * 0.01 ;
                	}
                	else {
                		...
                		Playerarray[k2].loosecreeps[Playerarray[k2].MatchNr] = Integer.parseInt(zws.substring(zws.indexOf("neutralMinionsKilled\"")+22,zws.indexOf("neutralMinionsKilledTeamJungle\"")-2))
                				+ Integer.parseInt(zws.substring(zws.indexOf("totalMinionsKilled\":")+20,zws.indexOf("neutralMinionsKilled\"")-2));
                		Playerarray[k2].loosescore[Playerarray[k2].MatchNr] = Playerarray[k2].loosekills[Playerarray[k2].MatchNr]*3 - Playerarray[k2].loosedeaths[Playerarray[k2].MatchNr] *2
                				+ Playerarray[k2].looseassists[Playerarray[k2].MatchNr] + Playerarray[k2].loosecreeps[Playerarray[k2].MatchNr] * 0.01 ;
                	}
                }
        	}
        }
        ...
        for (int i6 = 0;i6 < k;i6++){
        	...
        	System.out.println(Playerarray[i6].winscoreavg);
        	System.out.println(Playerarray[i6].loosescoreavg);
